...
const multerConfig = multer.diskStorage({
  destination: tempDir, // The folder to which the file has been saved after upload (temp dir)
  ...
  filename: (req, file, cb) => {
    ...
    // null - there you can send an error if something goes wrong. For example: cb(new Error('I don't have a clue!'))
  },
});
...
app.post(
  "/api/books",
  //$ or:
  upload.single("cover"), // for one file
  //$ or:
